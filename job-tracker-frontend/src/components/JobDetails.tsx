              ...
              <ContentSection>
                {job.job_url && (
                  <Section>
                    ...
                    <JobUrl href={job.job_url} target="_blank" rel="noopener noreferrer">
                      {job.job_url}
                    </JobUrl>
                  </Section>
                )}
                  ...
                  <ResumeSection>
                    ...
                    <ResumeCard>
                      <ResumeTitle>Uploaded Resume</ResumeTitle>
                                             <ResumeActions>
                         <ResumeButton onClick={() => window.open(`${API_BASE_URL}/jobs/${job.id}/resume`, '_blank')}>
                           <ButtonIcon fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         ...
                         <DownloadButton href={`${API_BASE_URL}/jobs/${job.id}/resume`} download>
                          <ButtonIcon fill="none" stroke="currentColor" viewBox="0 0 24 24">
